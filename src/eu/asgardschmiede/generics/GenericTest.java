...
public class GenericTest {
    public static void main(String[] args) {
        ...
        // Unsave
        System.out.println();
        Set menge = new HashSet();// Wird kein generischer Typ vorgegeben ist er per default Object
        menge.add("ABC"); //Object, String IS-A Object
        menge.add(123); // Object, Integer IS-A Object
        //Object o = menge.stream().findFirst(); //findFirst liefert das erste Element, Streams ab Java 1.8
