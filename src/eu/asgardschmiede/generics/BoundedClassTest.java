...
public class BoundedClassTest {
    public static void main(String[] args) {
        ...
        System.out.println(bc2.add(10.0, 22.0));

       // BoundedClass<String> bc3 = new BoundedClass<>();
       // System.out.println(bc3.add("10", "20"));

        BoundedClass2<String> bc3 = new BoundedClass2<>();
        System.out.println(bc3.append("Hallo"));
        System.out.println(bc3.append(" Welt"));

    }
}

// Ist ein Bound vorhanden wird beim generischen Type nicht mehr von Object ausgegangen
// sondern mind. der Typ des Bounds
